...
public interface IGUIHandler {
	...
	boolean sendMessage(List<String> recipient, String subject, String message, String type, Date sendTime, Date reminderTime) throws IllegalAccessException, EmptyRecipientException, EmptySubjectAndMessageException, IllegalEmailAddressException; //ClassNotFoundException, InstantiationException, 
